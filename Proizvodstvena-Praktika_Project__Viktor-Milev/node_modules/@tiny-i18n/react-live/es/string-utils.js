...
export var OPEN_STR = '\u206E';
export var CLOSE_STR = '\u206F';

export function wrapString(string) {
...
export function parseWrappedStringLinkedList(wrappedString) {
...
export function stripWrappedString(wrappedString) {
...
export function mergeWrappedStringLinked(wrappedString) {
