...
export var styleUsable = function styleUsable(style) {
...
export { singleView };
export var isElementOf = function isElementOf(Component) {
  ...
  var elementType = React.createElement(Component, null).type;
...
export var proxy = function proxy(ref, name, callback) {
  if (ref) {
    if (callback) {
...
export var OPEN_CHAR = '\u200B';
export var CLOSE_CHAR = '\u200C';
export function toWrappedString(string) {
...
export function getMaxLevel(string) {
  var level = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
